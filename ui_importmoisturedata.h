...
public:
    ...
    QPushButton *pushButtonExportTimeSeries;
    ...
    void setupUi(QDialog *ImportMoistureData)
    {
        ...
        ImportMoistureData->resize(400, 194);
        ...
        pushButtonExportTimeSeries = new QPushButton(ImportMoistureData);
        pushButtonExportTimeSeries->setObjectName(QString::fromUtf8("pushButtonExportTimeSeries"));

        verticalLayout->addWidget(pushButtonExportTimeSeries);
    ...
    void retranslateUi(QDialog *ImportMoistureData)
    {
        ...
        pushButtonExportTimeSeries->setText(QApplication::translate("ImportMoistureData", "ExportTimeSeries", nullptr));
    } // retranslateUi
