...
public:
    ...
    void setupUi(QDialog *DialogRoseMead)
    {
        ...
        StreetWidth = new QLineEdit(DialogRoseMead);
        StreetWidth->setObjectName(QString::fromUtf8("StreetWidth"));

        formLayout->setWidget(6, QFormLayout::FieldRole, StreetWidth);

        label_7 = new QLabel(DialogRoseMead);
        label_7->setObjectName(QString::fromUtf8("label_7"));

        formLayout->setWidget(6, QFormLayout::LabelRole, label_7);

        label_8 = new QLabel(DialogRoseMead);
        label_8->setObjectName(QString::fromUtf8("label_8"));

        formLayout->setWidget(7, QFormLayout::LabelRole, label_8);

        spinBox = new QSpinBox(DialogRoseMead);
    ...
    void retranslateUi(QDialog *DialogRoseMead)
    {
        ...
        label_2->setText(QApplication::translate("DialogRoseMead", "Extension to left", nullptr));
        ...
        label_5->setText(QApplication::translate("DialogRoseMead", "Number of cells in the left side", nullptr));
        ...
        label_7->setText(QApplication::translate("DialogRoseMead", "Street Width", nullptr));
        label_8->setText(QApplication::translate("DialogRoseMead", "Number of cells under street", nullptr));
    } // retranslateUi
