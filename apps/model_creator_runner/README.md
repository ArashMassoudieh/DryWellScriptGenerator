...
- VN generation also includes explicit optional file inputs:
  ...
  - VN build mode is selected from **Model enrichment preset** (VN-only options), and behavior is:
...
- Built-in enrichment presets include hq_drywell-specific monitoring-well/groundwater-boundary/pretreatment, VN-specific `VN_Drywell` + `VN_Drywell_Pro`, and r_bioswale-specific underdrain / underdrain+groundwater additions.
